...
import { AlertTriangle, Building2, Clock, ExternalLink, FileText, Globe, Search, User } from "lucide-react";
import { RequireAuth } from "@/components/RequireAuth";
import { Badge, EmptyState, ErrorNote, PageHeader, Section, Skeleton } from "@/components/ui";
import { api, attemptApi, type UserRow } from "@/lib/api";
              ...
              <div key={a.id} className="flex items-center justify-between p-3 rounded-lg"
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-[10px] text-muted flex items-center gap-2">
                      ...
                      {a.proctor_strikes != null && a.proctor_strikes > 0 && (
                        <span className="flex items-center gap-1 font-semibold" style={{ color: "var(--rag-red)" }}>
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  {a.status === "scored" && (
                    <>
                      <button
                        onClick={() => void attemptApi.openReport(a.id)}
